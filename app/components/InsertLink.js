/*
 * @Author: 刘俊琪
 * @Date: 2022-02-14 14:43:19
 * @LastEditTime: 2022-02-14 18:44:18
 * @Description: 描述
 */
/**
 *
        ...
        <View style={[styles.dialog]}>
          ...
          <View style={styles.item}>
            <TextInput
              ...
              placeholder={"Title"}
              onChangeText={(text) => this.setTitle(text.toLowerCase())}
            />
          </View>
          <View style={styles.item}>
            <TextInput
              ...
              placeholderTextColor={placeholderColor}
              placeholder='http(s)://'
              onChangeText={(text) => this.setURL(text.toLowerCase())}
            />
          </View>
